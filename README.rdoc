...
Rundown is a Javascript RDoc markup to HTML convertor.
...
The more others contribute to Rundown, the sooner full RDoc compability
will be acheived. As I am not a markup parser expert (nor a Javascript
...
Rundown is very much a contributor's project, so ackowledgment
